package com.fakecompany.sample.handler;

import com.fakecompany.sample.configuration.ErrorProperties;
import com.fakecompany.sample.domain.Error;
...
@ControllerAdvice(basePackages = "com.fakecompany")
